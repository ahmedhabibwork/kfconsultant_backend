        ...
        try {
            return $this->okResponse(
                ...
                [
                    ...
                    //     WhyUs::first()
                    // ),
                    'luxury_trips' => TripResource::collection(Trip::leftJoin('cities', 'trips.id', '=', 'trips_cities.trip_id')->where('trips_cities.slug', 'luxury')->inRandomOrder()->take(8)->get()),
                    'cairo_trips' => TripResource::collection(Trip::leftJoin('cities', 'trips.id', '=', 'trips_cities.trip_id')->where('trips_cities.slug', 'cairo')->inRandomOrder()->take(8)->get()),
