...
class FaqResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('question')->label(__('Question'))->sortable()->searchable(),
                Tables\Columns\TextColumn::make('answer')->label(__('Answer'))->sortable()->searchable(),
